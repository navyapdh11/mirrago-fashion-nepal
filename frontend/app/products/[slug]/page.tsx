      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {variants.map((v: any) => (
                  <button
                    key={v.id}
                    className="px-4 py-2 border-2 border-gray-300 rounded hover:border-nepal-red hover:text-nepal-red transition"
                  >
                    {v.size}
                  </button>
                ))}
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {product.style_tags?.map((tag: string, i: number) => (
          ...
          {/* Add to Cart */}
          <button className="w-full bg-nepal-red text-white py-4 rounded-lg font-semibold hover:bg-nepal-crimson transition flex items-center justify-center gap-2">
